        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="post">
                            ...
                            <p>It's essential to note that specific conditions, such as the duration of the fixed-rate period, the spread, and other terms, may vary between financial institutions in Portugal. Join us in streamlining and clarifying the financial decision-making process for common housing loans in Portuguese territory.</p>
                        </div>
                        ...
                        <div class="post clearfix">
                            ...
                            <p>Desenvolvido no âmbito da <b><a href="https://hackweek.opensuse.org/23/projects/mortgage-plan-analyzer">SUSE Hack Week 23</a></b>, o <b>Mortgage Plan Analyzer</b> é um projeto colaborativo destinado a simplificar a análise de propostas de crédito à habitação, com foco nas configurações mais comuns em Portugal. <br/>
                            ...
                            <p>Importante destacar que as condições específicas, como a duração do período de taxa fixa, o spread e outros termos, podem variar entre instituições financeiras em Portugal. Junte-se a nós para simplificar e esclarecer o processo de decisões financeiras em créditos habitacionais comuns em território português.</p>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="https://hackweek.opensuse.org/23/projects/mortgage-plan-analyzer" class="btn-link text-secondary"><i class="fa-brands fa-xl fa-suse pr-1"></i>Hack Week 23</a> </li>
